...
class saleDTO
{
	...
	/**
	 * @var string $collInvNo
	 */
	protected $collInvNo = null;
	...
	/**
	 * @var string $suppAmount
	 */
	protected $suppAmount = null;
	 ...
	 * @param string $collInvNo
	 */
	public function __construct($deliveryID, $destCountry, $eanNo, $itemID, $itemType, $location, $netWeight, $price, $priceCurrency, $quantityPCS, $transactionDate, $collInvNo)
	{
		...
		$this->collInvNo		= $collInvNo;
	}

	/**
	 * @return string
	 */
	public function getCollInvNo()
	{
		return $this->collInvNo;
	}
	 ...
	 * @return \GUS\saleDTO
	 */
	public function setCollInvNo($collInvNo)
	{
		$this->collInvNo = $collInvNo;
		return $this;
	}
	 ...
	 * @return string
	 */
	public function getSuppAmount()
	{
		return $this->suppAmount;
	}

	/**
	 * @param string $suppAmount
	 * @return \GUS\saleDTO
	 */
	public function setSuppAmount($suppAmount)
	{
